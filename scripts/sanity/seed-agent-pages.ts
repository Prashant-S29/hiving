...
import { DEFAULT_AGENT_DISCOVER_PAGE, DEFAULT_AGENT_PRICING_PAGE, DEFAULT_AGENT_STORE_PAGE } from "@/lib/sanity/agentPages";
...
const documents: SanityDocumentStub[] = [
  {
    _id: "agentStorePage",
    _type: "agentStorePage",
    ...DEFAULT_AGENT_STORE_PAGE,
    pricingAction: action(DEFAULT_AGENT_STORE_PAGE.pricingAction.label, DEFAULT_AGENT_STORE_PAGE.pricingAction.href),
    discoverAction: action(DEFAULT_AGENT_STORE_PAGE.discoverAction.label, DEFAULT_AGENT_STORE_PAGE.discoverAction.href),
    seo: { _type: "seo", ...DEFAULT_AGENT_STORE_PAGE.seo },
  },
  {
    _id: "agentPricingPage",
    _type: "agentPricingPage",
    ...DEFAULT_AGENT_PRICING_PAGE,
    backAction: action(DEFAULT_AGENT_PRICING_PAGE.backAction.label, DEFAULT_AGENT_PRICING_PAGE.backAction.href),
    seo: { _type: "seo", ...DEFAULT_AGENT_PRICING_PAGE.seo },
  },
  {
    _id: "agentDiscoverPage",
    _type: "agentDiscoverPage",
    ...DEFAULT_AGENT_DISCOVER_PAGE,
    seo: { _type: "seo", ...DEFAULT_AGENT_DISCOVER_PAGE.seo },
  },
];
